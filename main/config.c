...
_Static_assert(sizeof(app_cfg_t) == 176, "app_cfg_t layout changed: add its size to k_len_by_version");
...
void config_load(void)
{
    ...
    static const size_t k_len_by_version[] = { 0, 76, 78, 80, 82, 82, 118, 132, 136, 176 };
